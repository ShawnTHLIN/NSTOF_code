...
//const string folder = "20220730AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_12hours";
//const string folder = "20220801AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220802AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220803AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220812AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220813AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220814AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220815AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220816AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";

//const string folder = "20220901AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220906AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_12hours";
//const string folder = "20220906AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220907AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220909AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220912AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
//const string folder = "20220915AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_24hours";
...
//Xconst string folder = "20220905AmBe_HV1550_Trich0_3in150cm_Deg30_Ch4_2in2cm_Ch6_2in10cm_12hours";

const string MainFileName     = "data/"+ folder + "/UNFILTERED/Data_CH0@DT5730B_1173_" + folder + ".bin";
const string ATriggerFileName = "data/"+ folder + "/UNFILTERED/Data_CH4@DT5730B_1173_" + folder + ".bin";
...
string OutROIFileWaveName, OutMatrixFileName;
...
*/
	...
	// OutROIFileName =  "20211228_TOF_D150cm_d5cm_N_woPSD_g1g2_wPSD_12hrs.txt";  //need change
	
	//OutROIFileName =  "20221222_TOF_TH80_D150d5cm_N_woPSD_g1g2_wPSD_12hours.txt";  //need change
	//OutROIFileName2 = "20221222_TOF_TH80_D150d5cm_N_withPSD_g1g2_wPSD_12hours.txt";
	/*
	...
	wo,w : without, with
	*/
	OutMatrixFileName = "20221121_time_overlay_24hrs.txt";
...
/*	
		...
		cout << "ts: " << fATrigtimestamp/1000 << endl;
...
/*		
		...
		cout << "ts: " << fBTrigtimestamp/1000 << endl;
		cout << "E: " << fBTrigenergy << endl;
		cout << "sE: " << fBTrigshortEnergy << endl;
		cout << "Flag " << fBTrigflags << endl;
...
void WriteTo290File(){
	...
	*/
	if ((AAneutron == true)&&(BBneutron==false)){
		ROIoutFile  <<  ((fROItimestamp*1.0) - (fATrigtimestamp*1.0 )) / 1000.0 <<" "<< fROIPSP <<" " << fROIenergy <<" 4 "<< fATrigPSP <<" " << fATrigenergy << endl;
		
		//ROIoutFile  <<  fROItimestamp<<" "<< ((fROItimestamp*1.0) - (fATrigtimestamp*1.0 )) / 1000.0 <<" "<< fROIPSP <<" " << fROIenergy <<" 4 "<<fATrigtimestamp <<" "<<fATrigPSP <<" " << fATrigenergy << endl;
		//cout <<  ((fROItimestamp*1.0) - (fATrigtimestamp*1.0 )) / 1000.0 <<" "<< fROIPSP <<" " << fROIenergy <<" 4 "<< fATrigPSP <<" " << fATrigenergy << endl;
		//fgetc(stdin);
	}
	
	if ((AAneutron == false)&&(BBneutron==true)){
		ROIoutFile  <<  ((fROItimestamp*1.0) - (fBTrigtimestamp*1.0 )) / 1000.0 <<" " << fROIPSP  <<" "<< fROIenergy <<" 6 " << fBTrigPSP <<" " << fBTrigenergy << endl;
	}
