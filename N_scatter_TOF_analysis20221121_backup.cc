...
string OutROIFileName =  "processed_TOF_data/Tri_ch0_3in_30deg_d150cm_Ch4_2in_2cm_Ver3/" + folder + ".txt"; 
...
void WriteTo290File(){
	...
	*/
	if ((AAneutron == true)&&(BBneutron==false)){
		ROIoutFile  <<fROItimestamp<<" "<<  ((fROItimestamp*1.0) - (fATrigtimestamp*1.0 )) / 1000.0 <<" "<< fROIPSP <<" " << fROIenergy <<" 4 "<< fATrigPSP <<" " << fATrigenergy << endl;
